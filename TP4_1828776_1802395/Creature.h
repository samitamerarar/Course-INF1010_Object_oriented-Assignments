...
Date de modification: 31 octobre 2016 par Guy-Frank
...
public:
	...
	virtual void attaquer(const Pouvoir& pouvoir,Creature& creature);	//modifier à virtual
	int experienceGagnee(const Creature& creature);

	bool apprendrePouvoir(Pouvoir* pouvoir);
	bool oublierPouvoir(Pouvoir* pouvoir);

	std::string obtenirTypeCreature() const;	//retourne type de Creature
