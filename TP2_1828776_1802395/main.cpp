/*
Fichier: main.cpp
Auteur(s): Alexandre MAO, Tamer Arar, Guy-Frank Essome Penda
...
int main()
{
	...
	Creature* Pokachoum = new Creature(Pokachu);
	...
	Pouvoir* lanceFeuille = new Pouvoir(bouleDeFeu);
